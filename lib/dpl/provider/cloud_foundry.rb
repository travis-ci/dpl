  ...
  class Provider
    class CloudFoundry < Provider
      ...
      def initial_go_tools_install
        context.shell 'wget \'https://cli.run.pivotal.io/stable?release=debian64&source=github\' -qO cf-linux-amd64.tgz && tar -zxvf cf-linux-amd64.tgz && rm cf-linux-amd64.tgz'
      end
