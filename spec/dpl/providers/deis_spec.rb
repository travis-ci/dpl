describe Dpl::Providers::Deis do
  let(:args) { |e| %w(--controller deis.deisapps.com --username user --password pass --app app) + args_from_description(e) }
  ...
  describe 'by default', record: true do
    ...
    it { should have_run 'mv ~/deis ./deis' }
    it { should have_run %r(git push.*ssh://git@deis-builder.deisapps.com:2222/app.git) }
  ...
  describe 'given --verbose' do
    it { should have_run %r(git push -v ssh://git@deis-builder.deisapps.com:2222/app.git) }
  end
end
