describe Dpl::Providers::Pages do
  ...
  describe 'given --verbose' do
    ...
    it { should have_run "[info] Initializing local git repo in #{tmp}" }
  ...
  describe 'given --repo other/name' do
    ...
    it { should have_run 'git push --force --quiet "https://token@github.com/other/name.git" "gh-pages":"gh-pages" > /dev/null 2>&1' }
  end
  ...
  describe 'given --target_branch other' do
    ...
    it { should have_run 'git push --force --quiet "https://token@github.com/travis-ci/dpl.git" "other":"other" > /dev/null 2>&1' }
  end

  describe 'given --keep_history' do
